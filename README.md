...
Requires recent [Docker Desktop](https://www.docker.com/products/docker-desktop/) or other workable [installation of Docker Compose](https://docs.docker.com/compose/install/standalone/).
